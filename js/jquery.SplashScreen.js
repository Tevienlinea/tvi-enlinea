            ...
            if (settings.mobile || settings.desktop || settings.forceLoader) {
                ...
                function imgLoaded() {
                    ...
                    if (settings.progressCount) {
                        progCount.innerHTML = "<img src='img/tevienlinealogo.png' width=200 height=190><br>" + percentage;
                    }
                ...
                function pageLoadCompleted() {
                    ...
                    if (settings.fadeEffect){
                        fade(settings.id);
                        document.getElementById("splashscreen").style.posotion = "relative";
                    }
                ...
                id(settings.id).style.posotion = "relative";
            }
        }
